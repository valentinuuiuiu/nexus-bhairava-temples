"""
Wikipedia Addon for NewZyon/PAI-KAN Architecture
Temple 61 - Wikipedia Guardian
Purpose: Knowledge
...
class WikipediaAddon:
    """
    Wikipedia integration addon for MCP server
    Temple 61 of the 64 Bhairava Guardian Temples
    Guardian Purpose: Knowledge
    """
    ...
    def __init__(self, token: Optional[str] = None):
        ...
        if not self.token and "NO_AUTH_REQUIRED" != "NO_AUTH_REQUIRED":
            raise ValueError(
                ...
                f"Get your token from the Wikipedia developer portal."
            )
